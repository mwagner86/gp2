...
public class EinfacheEingabe {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String hobby = textEingeben("Hobby");
        String instrument = textEingeben("Instrument");
        int alter = intEingeben("Alter");

        // Eingaben auf Konsole ausgeben
        System.out.print("Hallo: " + vorname + " " + name + "! Du bist "
                + alter + " Jahre alt.");
        System.out.print(" Du bist hast " + hobby + " als Hobby und spielst das Instrument "+ instrument + ".");
    }
